...
/**
 * An instance of Adventure represents where the hero is, what she can do, and where she can go from there. It basically
 * contains all information about the state of the game world, from the hero's point of view.
 * <p/>
